...
plots_disp[[1]] <- ggplot(v_comp,aes(PC1,PC2)) + geom_point() + theme_bw()

plots_disp[[2]] <- ggplot(v_comp,aes(PC1,PC3)) + geom_point() + theme_bw()

plots_disp[[3]] <- ggplot(v_comp,aes(PC2,PC3)) + geom_point() + theme_bw()

grid.arrange(plots_disp[[1]],plots_disp[[2]],plots_disp[[3]],
